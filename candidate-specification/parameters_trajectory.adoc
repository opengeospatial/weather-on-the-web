...
include::WOTW-Common/openapi/schemas/REQ_rc-corridor_width-definition.adoc[]

include::WOTW-Common/openapi/schemas/REQ_rc-corridor_width-response.adoc[]
...
include::WOTW-Common/openapi/schemas/REQ_rc-corridor_height-definition.adoc[]

include::WOTW-Common/openapi/schemas/REQ_rc-corridor_height-response.adoc[]
...
include::WOTW-Common/openapi/schemas/REQ_rc-interpolation_width-definition.adoc[]
    
include::WOTW-Common/openapi/schemas/REQ_rc-interpolation_width-response.adoc[]
    
If not specified the query will not perform any interpolation of data along the `corridor_width`.  If the `interpolationX` method does not match an entry in the defined list of valid `interpolationX` methods for the collection a 403 message SHOULD be returned.
